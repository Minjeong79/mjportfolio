...
export default function CareerDetail3Page() {
  return (
    <section className="flex flex-col h-80vh xl:w-full xl:gap-x-8 xl:h-96 xl:overflow-y-scroll">
      ...
      <div className="flex-1">
        <div className="flex flex-col gap-y-4 ">
          ...
          <br />
          <br />
          고화질 이미지를 활용하여 상품을 명확하게 시각화했습니다. 상품
          카테고리에 따라 레이아웃을 구성하여 사용자들이 원하는 상품을 쉽게 찾을
